...
*/
        ...
        cfw.add(ByteCode.INSTANCEOF, "net/sourceforge/htmlunit/corejs/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "net/sourceforge/htmlunit/corejs/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "net/sourceforge/htmlunit/corejs/javascript/ScriptRuntime",
                      "doTopCall",
                      "(Lnet/sourceforge/htmlunit/corejs/javascript/Callable;"
                      +"Lnet/sourceforge/htmlunit/corejs/javascript/Context;"
                      +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                      +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lnet/sourceforge/htmlunit/corejs/javascript/Script;[Ljava/lang/String;)V");
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lnet/sourceforge/htmlunit/corejs/javascript/Context;"
                      +")Lnet/sourceforge/htmlunit/corejs/javascript/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "net/sourceforge/htmlunit/corejs/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "net/sourceforge/htmlunit/corejs/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptNode n)
    {
        ...
        sb.append("Lnet/sourceforge/htmlunit/corejs/javascript/Context;"
                  +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                  +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
          +"Lnet/sourceforge/htmlunit/corejs/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lnet/sourceforge/htmlunit/corejs/javascript/NativeFunction;"
                               +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lnet/sourceforge/htmlunit/corejs/javascript/NativeFunction;"
                               +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                               +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;II"
                               +")Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;");
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lnet/sourceforge/htmlunit/corejs/javascript/Context;)V");
    }
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lnet/sourceforge/htmlunit/corejs/javascript/Context;"
                    +")Lnet/sourceforge/htmlunit/corejs/javascript/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lnet/sourceforge/htmlunit/corejs/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                            +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lnet/sourceforge/htmlunit/corejs/javascript/Callable;"
                            +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                            +"Lnet/sourceforge/htmlunit/corejs/javascript/Context;"
                            +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "net/sourceforge/htmlunit/corejs/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "net/sourceforge/htmlunit/corejs/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            exceptionName = "net/sourceforge/htmlunit/corejs/javascript/EcmaError";
