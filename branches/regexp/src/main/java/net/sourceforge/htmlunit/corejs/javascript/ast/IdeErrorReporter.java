 ...
 * If the {@link net.sourceforge.htmlunit.corejs.javascript.Parser}'s error reporter is
 * set to an instance of this interface, then this interface's
 * {@link #warning} and {@link #error} methods are called instead
 * of the {@link net.sourceforge.htmlunit.corejs.javascript.ErrorReporter} versions. <p>
 *
