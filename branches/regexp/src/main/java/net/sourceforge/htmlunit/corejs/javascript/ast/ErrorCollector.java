 ...
 * This a useful {@link net.sourceforge.htmlunit.corejs.javascript.ErrorReporter} when the
 * {@link net.sourceforge.htmlunit.corejs.javascript.CompilerEnvirons} is set to
 * ide-mode (for IDEs).
 *
 * @author Steve Yegge
 */
