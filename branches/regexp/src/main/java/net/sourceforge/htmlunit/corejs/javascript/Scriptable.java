...
public interface Scriptable {
     ...
     * <LI>net.sourceforge.htmlunit.corejs.javascript.Scriptable objects</LI>
     * <LI>null</LI>
     ...
     * @see net.sourceforge.htmlunit.corejs.javascript.Context#getUndefinedValue
     */
     ...
     * @see net.sourceforge.htmlunit.corejs.javascript.Scriptable#get(String, Scriptable)
     * @see net.sourceforge.htmlunit.corejs.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see net.sourceforge.htmlunit.corejs.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see net.sourceforge.htmlunit.corejs.javascript.Scriptable#get(String, Scriptable)
     * @see net.sourceforge.htmlunit.corejs.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see net.sourceforge.htmlunit.corejs.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see net.sourceforge.htmlunit.corejs.javascript.Scriptable#get(int, Scriptable)
     * @see net.sourceforge.htmlunit.corejs.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see net.sourceforge.htmlunit.corejs.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see net.sourceforge.htmlunit.corejs.javascript.Scriptable#get(String, Scriptable)
     * @see net.sourceforge.htmlunit.corejs.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see net.sourceforge.htmlunit.corejs.javascript.Scriptable#get(int, Scriptable)
     * @see net.sourceforge.htmlunit.corejs.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
