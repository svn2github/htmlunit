...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link net.sourceforge.htmlunit.corejs.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected net.sourceforge.htmlunit.corejs.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return net.sourceforge.htmlunit.corejs.javascript.xml.XMLLib.Factory.create(
                "net.sourceforge.htmlunit.corejs.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return net.sourceforge.htmlunit.corejs.javascript.xml.XMLLib.Factory.create(
                "net.sourceforge.htmlunit.corejs.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
