...
/**
 * Exception thrown by 
 * {@link net.sourceforge.htmlunit.corejs.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link net.sourceforge.htmlunit.corejs.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link net.sourceforge.htmlunit.corejs.javascript.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link net.sourceforge.htmlunit.corejs.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link net.sourceforge.htmlunit.corejs.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link net.sourceforge.htmlunit.corejs.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link net.sourceforge.htmlunit.corejs.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
