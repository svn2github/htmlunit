...
public class ScriptRuntime {
    ...
    public final static Class<?>
        ContextClass
            = Kit.classOrNull("net.sourceforge.htmlunit.corejs.javascript.Context"),
        ContextFactoryClass
            = Kit.classOrNull("net.sourceforge.htmlunit.corejs.javascript.ContextFactory"),
        FunctionClass
            = Kit.classOrNull("net.sourceforge.htmlunit.corejs.javascript.Function"),
        ScriptableObjectClass
            = Kit.classOrNull("net.sourceforge.htmlunit.corejs.javascript.ScriptableObject");
    public static final Class<Scriptable> ScriptableClass =
        Scriptable.class;

    private static final String[] lazilyNames = {
        "RegExp",        "net.sourceforge.htmlunit.corejs.javascript.regexp.NativeRegExp",
        "Packages",      "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "java",          "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "javax",         "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "org",           "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "com",           "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "edu",           "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "net",           "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "getClass",      "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage",
        "JavaAdapter",   "net.sourceforge.htmlunit.corejs.javascript.JavaAdapter",
        "JavaImporter",  "net.sourceforge.htmlunit.corejs.javascript.ImporterTopLevel",
        "Continuation",  "net.sourceforge.htmlunit.corejs.javascript.NativeContinuation",
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "net.sourceforge.htmlunit.corejs.javascript.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource
                = "net.sourceforge.htmlunit.corejs.javascript.resources.Messages";
