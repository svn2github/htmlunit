...
package jdk2.nashorn.internal.parser;

import static jdk2.nashorn.internal.codegen.CompilerConstants.ANON_FUNCTION_PREFIX;
import static jdk2.nashorn.internal.codegen.CompilerConstants.EVAL;
import static jdk2.nashorn.internal.codegen.CompilerConstants.PROGRAM;
import static jdk2.nashorn.internal.parser.TokenType.ASSIGN;
import static jdk2.nashorn.internal.parser.TokenType.CASE;
import static jdk2.nashorn.internal.parser.TokenType.CATCH;
import static jdk2.nashorn.internal.parser.TokenType.COLON;
import static jdk2.nashorn.internal.parser.TokenType.COMMARIGHT;
import static jdk2.nashorn.internal.parser.TokenType.CONST;
import static jdk2.nashorn.internal.parser.TokenType.DECPOSTFIX;
import static jdk2.nashorn.internal.parser.TokenType.DECPREFIX;
import static jdk2.nashorn.internal.parser.TokenType.ELSE;
import static jdk2.nashorn.internal.parser.TokenType.EOF;
import static jdk2.nashorn.internal.parser.TokenType.EOL;
import static jdk2.nashorn.internal.parser.TokenType.FINALLY;
import static jdk2.nashorn.internal.parser.TokenType.FUNCTION;
import static jdk2.nashorn.internal.parser.TokenType.IDENT;
import static jdk2.nashorn.internal.parser.TokenType.IF;
import static jdk2.nashorn.internal.parser.TokenType.INCPOSTFIX;
import static jdk2.nashorn.internal.parser.TokenType.LBRACE;
import static jdk2.nashorn.internal.parser.TokenType.LET;
import static jdk2.nashorn.internal.parser.TokenType.LPAREN;
import static jdk2.nashorn.internal.parser.TokenType.RBRACE;
import static jdk2.nashorn.internal.parser.TokenType.RBRACKET;
import static jdk2.nashorn.internal.parser.TokenType.RPAREN;
import static jdk2.nashorn.internal.parser.TokenType.SEMICOLON;
import static jdk2.nashorn.internal.parser.TokenType.TERNARY;
import static jdk2.nashorn.internal.parser.TokenType.WHILE;
...
import jdk2.internal.dynalink.support.NameCodec;
import jdk2.nashorn.internal.codegen.CompilerConstants;
import jdk2.nashorn.internal.codegen.Namespace;
...
import jdk2.nashorn.internal.ir.BlockLexicalContext;
...
import jdk2.nashorn.internal.ir.PropertyKey;
...
import jdk2.nashorn.internal.ir.debug.ASTWriter;
import jdk2.nashorn.internal.ir.debug.PrintVisitor;
import jdk2.nashorn.internal.runtime.Context;
import jdk2.nashorn.internal.runtime.ErrorManager;
import jdk2.nashorn.internal.runtime.JSErrorType;
...
import jdk2.nashorn.internal.runtime.Timing;
