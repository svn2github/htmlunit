...
import static jdk2.nashorn.internal.codegen.CompilerConstants.CLINIT;
import static jdk2.nashorn.internal.codegen.CompilerConstants.CONSTANTS;
import static jdk2.nashorn.internal.codegen.CompilerConstants.GET_ARRAY_PREFIX;
import static jdk2.nashorn.internal.codegen.CompilerConstants.GET_ARRAY_SUFFIX;
...
import static jdk2.nashorn.internal.codegen.CompilerConstants.INIT;
import static jdk2.nashorn.internal.codegen.CompilerConstants.SET_MAP;
import static jdk2.nashorn.internal.codegen.CompilerConstants.SOURCE;
import static jdk2.nashorn.internal.codegen.CompilerConstants.STRICT_MODE;
...
import jdk2.nashorn.internal.ir.debug.NashornClassReader;
import jdk2.nashorn.internal.ir.debug.NashornTextifier;
...
public class ClassEmitter implements Emitter {
    ...
    ClassEmitter(final Context context, final String sourceName, final String unitClassName, final boolean strictMode) {
        ...
        cw.visit(V1_7, ACC_PUBLIC | ACC_SUPER, unitClassName, null, pathName(jdk2.nashorn.internal.scripts.JS.class.getName()), null);
    ...
    public void end() {
        ...
        if (unitClassName != null) {
            ...
            initMethod.newInstance(jdk2.nashorn.internal.scripts.JS.class);
