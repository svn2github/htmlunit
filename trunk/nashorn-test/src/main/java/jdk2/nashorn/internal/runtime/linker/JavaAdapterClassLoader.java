...
import jdk2.nashorn.internal.codegen.DumpBytecode;
        ...
        return new SecureClassLoader(parentLoader) {
            ...
            protected Class<?> findClass(final String name) throws ClassNotFoundException {
                if(name.equals(className)) {
                    ...
                    DumpBytecode.dumpBytecode(ctx.getEnv(), ctx.getLogger(jdk2.nashorn.internal.codegen.Compiler.class), classBytes, name);
