...
import jdk2.internal.dynalink.linker.ConversionComparator;
import jdk2.internal.dynalink.linker.GuardedInvocation;
import jdk2.internal.dynalink.linker.GuardedTypeConversion;
...
final class NashornPrimitiveLinker implements TypeBasedGuardingDynamicLinker, GuardingTypeConverterFactory, ConversionComparator {
     ...
     * @return one of {@link jdk2.internal.dynalink.linker.ConversionComparator.Comparison} values signifying which
