 ...
 * </pre>
 * You can also use {@link jdk2.nashorn.internal.objects.NativeJava#type(Object, Object)} to access Java classes. These two statements are mostly
 * equivalent:
 * <pre>
...
public final class NativeJavaPackage extends ScriptObject {
    ...
    /**
     * Public constructor to be accessible from {@link jdk2.nashorn.internal.objects.Global}
